...
- add RGB cutout for switch LED mounting
- redraw traces for above components
- adjust sizing and spacing for buttons
- CAD up top, bottom plate, dongle hatch and switch plate
